...
<div class="total-display-container">
    <table width="100%" cellspacing="0px" border="0" class="total-display-table @if(count($estimate->items) > 12) page-break @endif">
        ...
        <tr>
            ...
            <td class="py-8 border-0 total-border-right item-cell total-table-attribute-value" style="color: #333">
                {!! format_money_pdf($estimate->total, $estimate->customer->currency)!!}&nbsp;{{$estimate->customer->currency->code}}
            </td>
        </tr>
    </table>
</div>
